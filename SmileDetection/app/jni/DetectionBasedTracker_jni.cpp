...
JNIEXPORT jlong JNICALL Java_com_mosida_smiledetection_DetectionBasedTracker_nativeCreateObject
(JNIEnv * jenv, jclass, jstring jFileName, jint faceSize)
{
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeCreateObject enter");
    const char* jnamestr = jenv->GetStringUTFChars(jFileName, NULL);
    string stdFileName(jnamestr);
    jlong result = 0;

    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeCreateObject");
    ...
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeCreateObject exit");
    return result;
}

JNIEXPORT void JNICALL Java_com_mosida_smiledetection_DetectionBasedTracker_nativeDestroyObject
(JNIEnv * jenv, jclass, jlong thiz)
{
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeDestroyObject");
    ...
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeDestroyObject exit");
}

JNIEXPORT void JNICALL Java_com_mosida_smiledetection_DetectionBasedTracker_nativeStart
(JNIEnv * jenv, jclass, jlong thiz)
{
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeStart");
    ...
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeStart exit");
}

JNIEXPORT void JNICALL Java_com_mosida_smiledetection_DetectionBasedTracker_nativeStop
(JNIEnv * jenv, jclass, jlong thiz)
{
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeStop");
    ...
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeStop exit");
}

JNIEXPORT void JNICALL Java_com_mosida_smiledetection_DetectionBasedTracker_nativeSetFaceSize
(JNIEnv * jenv, jclass, jlong thiz, jint faceSize)
{
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeSetFaceSize -- BEGIN");
    ...
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeSetFaceSize -- END");
}
...
{
    LOGD("Java_com_mosida_smiledetection_DetectionBasedTracker_nativeDetect");
